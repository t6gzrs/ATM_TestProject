...
namespace E_ATM_T6G
{
    ...
    class ATM
    {
        ...
        static string ATM_ID = "T6GNATUNIV";
        static string ATM_LOC = "KEARNY MESA";

        public ATM()
        {
            // user details stub  
            usr[0] = new usrDetails(1234, "T6GNATUNI2093", "Savings", "Katy Craig", 40000, 1122);
            usr[1] = new usrDetails(1111, "T6GNATUNI8690", "Current", "Anthony Fuentes", 15000, 1111);

            usr[2] = new usrDetails(2222, "T6GNATUNI8690", "Savings", "Steve Werderman", 45000, 2222);
            usr[3] = new usrDetails(3333, "T6GNATUNI8690", "Current", "Robert -Mike- Oliver", 15000, 3333);

            usr[4] = new usrDetails(4444, "T6GNATUNI8690", "Savings", "Donald Smith", 50000, 4444);
            usr[5] = new usrDetails(5555, "T6GNATUNI8690", "Current", "Chuck Bane", 65000, 5555);

            usr[6] = new usrDetails(6666, "T6GNATUNI8690", "Savings", "Christopher Simpson", 85000, 6666);
            usr[7] = new usrDetails(7777, "T6GNATUNI8690", "Current", "John Dill", 95000, 7777);

            usr[8] = new usrDetails(8888, "T6GNATUNI8690", "Savings", "Sheldon Cooper", 75000, 8888);
            usr[9] = new usrDetails(9999, "T6GNATUNI8690", "Current", "Gabriel Iglesias", 10000, 9999);

            usr[9] = new usrDetails(12345, "T6GNATUNI7650", "Savings", "Hugo -Big Jucie- Santaella", 100000, 12345);
        ...
        CLEAR:
            if (check)
            {
                if (usr[i].last_access != null) // Halt user for a day from using ATM after he or she comepletes 10 transactions  
                {
                ...
                try
                {
                    ...
                    if (temp >= 100)
                    {
                        ...
                        {
                            Start.UI_error("Funds can't exceed $.1000\n\t\t\t in single transaction!");
                            return;
                        }
                    }
                    else
    ...
    class Start
    {
        ...
        public static int UI_main(ref int atm_n)
        {
            ...
            Console.WriteLine(xst + "3.Balance Inquiry.\t\t4.Fund Trans.\n");
            ...
            while (true)
            {
                ...
                switch (mnuChoice)
                {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        UI_msgbox("Thankyou for visting T6G ATM.\n");
